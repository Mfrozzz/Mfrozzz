# Hello, my name is Marcos Vinicius Schimaichel Boava. 🤙
...
<div>
  ...
  #### Languages
  [![Languages](https://skillicons.dev/icons?i=ts,js,html,css,py,c,cpp,java,php,go,sass)](https://skillicons.dev)

  #### Libraries and Frameworks
  [![Frameworks](https://skillicons.dev/icons?i=nodejs,express,angular,react,laravel,materialui,tailwind,bootstrap,jest,vite,opencv,prisma,hibernate)](https://skillicons.dev)

  #### Tools and platforms
  [![Tools](https://skillicons.dev/icons?i=azure,docker,firebase,git,github,gcp,linux,mongodb,mysql,postgres,postman,vscode,windows)](https://skillicons.dev)

  ### 📝 Learning About
  [![Learning](https://skillicons.dev/icons?i=androidstudio,aws,cs,dart,dotnet,flask,flutter,nextjs,ruby,rails,spring,unity,vue)](https://skillicons.dev)
